...
mainopens.Parent = mainopen
 ...
 loki.Image = "rbxassetid://16266479120"
 ...
 Hub.Position = UDim2.new(0, 120, 0, 0)
 Hub.Size = UDim2.new(0, 81, 0, 27)
 Hub.Font = Enum.Font.Code
 Hub.Text = "| Code by Neyoshi - Kyouko |"
...
--------------------------------------------------------------------
local Library = Update:Window("Neyoshii Hub","")
------------------------------------------
...
Setting:Label("Join Neyoshii's discord server to update more new things!")

Setting:Line()

Setting:Button("Copy link",function()
